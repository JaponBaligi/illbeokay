...
var spr_staff_stn = preload("res://Textures/Items/Skills/sorcerer-staff-stn.png")
var spr_staff_atk = preload("res://Textures/Items/Skills/sorcerer-staff-atk.png")
...
@onready var staff_attack_snd = $staff_attack_snd
...
func enable_attack(atk = true):
	if atk:
		...
		sprite.texture = spr_staff_atk
	else:
		collision.call_deferred("set","disabled",true)
		sprite.texture = spr_staff_stn
